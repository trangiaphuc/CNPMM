...
export default function SVUpdateFood({ navigation, route }) {
  ...
  return (
    <View>
      <View style={styles.return}>
        ...
        <Text style={styles.returnText}>Chinh sua</Text>
      </View>
          ...
          {inputFieldsMaterial.map((inputFieldsMaterial, index) => (
            <View style={{ marginTop: 10 }} key={index}>
              <View style={{ flexDirection: "row" }}>
                ...
                >
                  <FontAwesome name="minus" color="#05375a" size={20} />
                </TouchableOpacity>
                <TouchableOpacity
                  style={{
                    flex: 1,
            ...
            <View style={{ marginTop: 10 }} key={index}>
              <View style={{ flexDirection: "row" }}>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => handleRemoveStepDes(index)}
                >
                  <FontAwesome name="minus" color="#05375a" size={20} />
                </TouchableOpacity>
                <TouchableOpacity
