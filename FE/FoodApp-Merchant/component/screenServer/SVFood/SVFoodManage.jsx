...
export default function SVFoodManage({ navigation, route }) {
      ...
      <View>
        <View style={styles.return}>
          ...
          <View style={styles.returnText}>
            <Text style={styles.returnTextDetail}>Tìm kiếm</Text>
          </View>
        </View>
        <ScrollView>
          <View>
            {search.map((item) => (
              <SafeAreaView key={item.id}>
                <TouchableOpacity
                  onPress={() => {
                    navigation.navigate("SVFoodDetail", {
                      userData: userData,
                      foodId: item.id,
                    });
                  }}
                >
                  <View style={styles.container_food}>
                    ...
                    <View style={{ flex: 15 }}>
                      ...
                      <Text style={{ marginLeft: 10 }} numberOfLines={2}>
  ...
  return (
    <View>
      <View style={styles.return}>
        ...
        <View style={styles.returnText}>
          <Text style={styles.returnTextDetail}>Món ăn</Text>
        </View>
        <TouchableOpacity
          style={styles.returnPlus}
          onPress={() => {
            navigation.navigate("SVAddNewFood", {
              userData: userData,
            });
          }}
        >
      ...
      {/* <View style={styles.return}>
        ...
        <View style={styles.addProduct}>
          <TouchableOpacity
            ...
            onPress={() => {
              navigation.navigate("addNewFoodScreen", {
                userData: userData,
                foodCategory: foodCategory,
              });
            }}
          >
            <FontAwesome name="plus" color="#05375a" size={30} />
          </TouchableOpacity>
        </View>
      </View> */}
