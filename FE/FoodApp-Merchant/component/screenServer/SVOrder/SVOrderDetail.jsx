...
export default function SVOrderDetail({ navigation, route }) {
  ...
  return (
    <View>
      ...
      <View>
        ...
        <View
          style={{ backgroundColor: "#DCDCDC", height: 280, borderRadius: 20 }}
        >
          <View style={styles.paymentMethod}>
            ...
            <Text style={{ marginLeft: 40 }}>
              {orders.paymentMethod.paymentType}
            </Text>
          </View>
          <View style={styles.paymentMethod}>
            <Text style={{ marginLeft: 15, fontSize: 20, fontWeight: "bold" }}>
            ...
            <Text style={{ marginLeft: 40 }}>
              {orders.deliveryMethod.deliveryMethod}
            </Text>
          </View>
          <View style={{ flexDirection: "row" }}>
            <Text
