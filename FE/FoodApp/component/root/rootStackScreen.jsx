...
const rootStackScreen = () => (
  <RootStack.Navigator headerShown={false}>
    ...
    />
    <RootStack.Screen
      name="updateFavoriteFoodScreen"
      component={updateFavoriteFoodScreen}
      options={{ headerShown: false }}
    />
    <RootStack.Screen
      name="billScreen"
    ...
    />
    <RootStack.Screen
      name="foodMaterialsScreen"
      component={foodMaterialsScreen}
      options={{ headerShown: false }}
    />
    <RootStack.Screen
    ...
    />
    <RootStack.Screen
      name="marketNoteScreen"
      component={marketNoteScreen}
      options={{ headerShown: false }}
    />
  </RootStack.Navigator>
);
